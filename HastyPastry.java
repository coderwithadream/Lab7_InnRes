...
grant all on spring2018.hp_goods to hasty@'%';
grant all on spring2018.hp_customers to hasty@'%';
grant all on spring2018.hp_items to hasty@'%';
grant all on spring2018.hp_receipts to hasty@'%';

-- Shell init:
export CLASSPATH=$CLASSPATH:mysql-connector-java-5.1.44-bin.jar:.
export HP_JDBC_URL=jdbc:mysql://csc365spring2018.webredirect.org/spring2018?autoReconnect=true\&useSSL=false
export HP_JDBC_USER=
export HP_JDBC_PW=
 */
